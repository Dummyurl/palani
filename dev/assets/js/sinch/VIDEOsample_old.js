...
$(document).on('click','.startVideo', function(event) {
	...
	var signInObj = {};
	signInObj.username = $('input#sinch_username').val();
	signInObj.password = $('input#sinch_username').val();
	...
	sinchClient.start(signInObj, function() {
		...
		if(typeof localStorage[sessionName] == 'undefined'){
			...
			window.location=base_url+'user/meetings/'+$('#start_session').val();
		}
...
$('button#logOut').on('click', function(event) {
	...
	//Reload page.
	window.location=base_url+'conversations';
});
