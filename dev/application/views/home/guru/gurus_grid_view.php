                ...
                <div class="widget-heading widget-default b-b-0 clearfix">
                        ...
                        <div class="view-format pull-right">
                                ...
                                <div class="btn-group">
                                        ...
                                        <a id="results-grid-view" class="btn btn-default active" href="#" title="List View"><i class="fa fa-th"></i></a>
                                </div>
                        </div>
                </div>
        </div>
         ...
         <?php if(!empty($gurus)): ?>
                ...
                <div class="col-sm-4">
                        <a href="<?php echo base_url(); ?>user/gurus_detail/<?php echo $guru_list['id']; ?>" class="guru-list">
                                ...
                                <div class="price"><span class="currency">$</span> <span class="amount"><?php echo $guru_list['mentor_charge']; ?></span>/hour</div>
                        </a>
                </div>
