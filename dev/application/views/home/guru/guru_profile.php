                ...
                <div class="profile-top">
                    <div class="row">
                        <div class="col-md-3 col-sm-5 col-xs-12">
                            ...
                            ?>
                            <a href="#" title="<?php echo $gurus['first_name']." ".$gurus['last_name']; ?>"><img alt="<?php echo $gurus['first_name']." ".$gurus['last_name']; ?>" class="img-responsive img-circle" src="<?php echo $img; ?>" style="width:100%"></a>
                        </div>
                    </div>
