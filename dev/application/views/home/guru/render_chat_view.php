<?php foreach($latest_chat as $key => $currentuser) :  ?>
                <div class="chat <?php echo ($currentuser['sender_id'] != $this->session->userdata('applicant_id')) ? 'chat-left' : '';?>">
                    ...
                    <img alt="User" src="<?php echo ($currentuser['senderImage'] != '') ? base_url().'assets/images/'.$currentuser['senderImage']: base_url().'assets/images/avatar.png'; ?>" class="img-responsive img-circle">
                    </a>
                    </div>
                    <div class="chat-body">
