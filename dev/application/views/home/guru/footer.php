            ...
            <form id="newCall">
              ...
              <ul>
                ...
                <li class="btn btn-danger">
                  ...
                  <button id="mute_mic" type="button">

                  <img src="<?php echo base_url(); ?>assets/images/micmute-icon.png">
...
<!-- <button data-toggle="modal" data-target="#rating_modal">Click</button> -->
