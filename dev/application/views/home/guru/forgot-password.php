    	...
    	<div class="container">
			<div class="account-box">
				...
				<h3 class="account-title">Forgot Password</a></h3>
                                <span id="guru_forgot_password_success" class="success" style="display: none"> </span>
                                <span id="guru_forgot_password_error" class="error" style="display: none"> </span>
				<form id="guru_forgot_password_form">
				...
				<div class="text-right m-t-30"><a class="forgot-link" href="<?php echo base_url()."guru/login"; ?>">Back to Login</a></div>
			</div>
        </div>
    </section>
