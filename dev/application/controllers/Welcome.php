...
//        return($curl_scraped_page);
    ...
    public function send_otp()
    {
      ...
      $mobile = $mobilenumber['mobile_number'];
          $this->session->set_userdata('smsgatewaycenterotp',$this->smsgatewaycenter_com_OTP()); //Generate OTP
          $message = 'Your one time password (OTP): '.$this->session->userdata('smsgatewaycenterotp');
          $this->smsgatewaycenter_com_Send($mobile,$message,$debug);
      }
