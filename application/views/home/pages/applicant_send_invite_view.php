...
<title>Invitation From Applicant</title>
</head>
        	...
        	<table width="100%" cellpadding="0" cellspacing="0" align="center">
                <tr>
                    <td>
                        ...
                        <h2 style="font-family:Arial, Helvetica, sans-serif; font-size:24px; color:#808080; font-weight:normal; margin:0 0 30px 0; padding:0;">Applicant invited you from <span style="font-weight:bold; color:#5c65be;">SchoolGuru</span></h2>
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#808080; font-weight:normal; margin:0; padding:0;">Please click the below link to contact the user.</p>
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#ffffff; font-weight:normal; margin:15px 0 0 0; padding:0;"><a href="<?php echo base_url(); ?>user/invite_success/<?php echo base64_encode($invite_id); ?>" style="color:#ffffff; padding:12px 25px 12px 25px; background:#5c65be; display:inline-block; text-decoration:none; border-radius:8px;">Accept Invitation</a></p>
                    </td>
                </tr>
            </table>	
        </td>
