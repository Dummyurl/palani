...
<div class="row">
        <div class="col-sm-3 col-xs-4 leftsidebar">
                <div class="theiaStickySidebar">
                    ...
                    <br><br><h3 class="filter-title">Filters</h3>
...
<!--                        <div class="view-format pull-right">
    ...
    <?php foreach($gurus as $guru_list):   ?>
        ...
        <div class="load-more-btn text-center">
           <button class="loadmore_search btn btn-default" data-page="2"><i class="fa fa-refresh"></i> Load More</button>
        </div>
        <?php } ?>
    </div>
    </div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="advance_search">Search</button>
                  </div>
                    </form>
                </div>
              </div>
