        	...
        	<table width="100%" cellpadding="0" cellspacing="0" align="center">
                <tr>
                    <td>
                        ...
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#ffffff; font-weight:normal; margin:30px 0 0 0; padding:0;"><a href="<?php echo base_url(); ?>welcome/gurus_detail/<?php echo $username; ?>" style="color:#ffffff; padding:12px 25px 12px 25px; background:#5c65be; display:inline-block; text-decoration:none; border-radius:8px;">View Profile</a></p>
                    </td>
                </tr>
            </table>	
        </td>
