            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="mentor_personal_message" id="mentor_personal_message" maxlength="500" ><?php echo $mentor_personal_message=$result['mentor_personal_message']; ?></textarea>
                  <br>
            ...
            <div class="row">
              <div class="col-sm-6 form-inline">
                <div class="form-group">
                  ...
                  <label class="control-label charing-details">
                    <p><input type="radio" class="form-control charge-radio" name="charge_type" value="free" <?php if( $result['charge_type'] == 'free'){ echo 'checked="checked"'; } ?>></p>
                    <p> Free</p></label>
                ...
                <div class="col-sm-6 form-inline">
                  <div class="form-group">
                    <label class="control-label charing-details">
                      <p><input type="radio" class="form-control charge-radio" name="charge_type" value="charge" <?php if( $result['charge_type'] == 'charge'){ echo 'checked="checked"'; } ?> ></p>
                      <p> Charge (per hour in dollar)</p>
                    </label><br>
                    <input type="text" class="form-control" name="hourly_rate" id="hourly_rate" 
                    maxlength="5"
                    value="<?php echo $result['hourly_rate']; ?>" required min="1"  <?php if( $result['charge_type'] != 'charge'){ echo 'disabled'; } ?> onkeypress="return isRate(event)">
                    <span class="help-block"></span>
                  </div>
                </div>
              </div>
