	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style_faq.css"> <!-- Resource style -->
...
<script src="<?php echo base_url(); ?>assets/js/main_1.js"></script> <!-- Resource jQuery -->
</body>
</html>