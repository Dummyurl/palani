<div class="row" id="account">
  <div class="row titlerow">
    ...
    if($total_earned == '0.00'){
      ...
      $title = "Please update your bank account details !";
    }else{
    ...
    <div class="col-sm-6">
      <div class="account-details-one">
        <div class="row">
          <div class="col-sm-4 col-md-4 spa_earned"><span>$<?php echo number_format($paid_amt,2); ?></span>Earned</div>
          <div class="col-sm-4 col-md-4 spa_paid"><span>$<?php echo number_format($requested_amt,2); ?></span>Requested</div>
          <div class="col-sm-4 col-md-4 spa_balance"><span>$<?php echo number_format($balance_amt,2); ?></span>Balance</div>
          <div class="spa_paynow">
            <a class="<?php echo $class_name; ?>" <?php echo $modal ?> title="<?php echo $title; ?>">Payment Request</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">                
        <div class="alert alert-danger error">
          <i class="fa fa-warning"></i><?php echo $title; ?></div>                                
        </div>
        <div class="clearfix"></div>
        <div class="modal-footer">                
