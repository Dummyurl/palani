...
<div class="card-box callbox">
    <div class="row">
        <div class="col-sm-6 col-md-8">
            ...
            <input type="hidden" id="applicant_image<?php echo $i;?>" value="<?php echo $img; ?>">
            <input type="hidden" id="applicant_name<?php echo $i;?>" value="<?php echo $conversation['first_name'].' '.$conversation['last_name']; ?>">
            <input type="hidden" id="logged_in<?php echo $i;?>" value="<?php echo $conversation['logged_in']; ?>">
            <input type="hidden" id="applicant_username<?php echo $i;?>" value="<?php echo $conversation['username']; ?>">
            <input type="hidden" id="applicant_user_id<?php echo $i;?>" value="<?php echo $conversation['app_id']; ?>">
            <?php 
            ...
            <input type="hidden" id="receiver_id" value="<?php echo $conversation['app_id']; ?>"> 
        </div>        
