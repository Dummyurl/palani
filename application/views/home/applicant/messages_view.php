                        ...
                        <div class="panel m-b-0 hidden" id="chat_box">
                            <div class="panel-heading"> 
                                ...
                                <div class="pull-right chattrash">
                                	<a href="javascript:void(0)" onclick="delete_conversation1();" title="Delete Chat History"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                </div>
                                    ...
                                    <div class="message-inner">
                                       ...
                                       <div class="message-area">
                                        <input type="text" name="input_message" id="input_message" placeholder="Type message..." class="chat-input" autocomplete="off">
                                            <input  type="hidden" id="recipients" value="username" >  <!-- Sinch username -->
                                            <input type="hidden" name="to_user_id" id="to_user_id" value="0">  <!-- to user id  -->
                                            <input type="hidden" name="time" id="time" >           <!-- time                                     -->
