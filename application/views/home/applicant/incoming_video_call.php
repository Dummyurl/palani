...
<div class="videocontrols-mob visible-xs">
 ...
 <!--      <div class="pull-right chattrash">
   ...
   <div class="panel-body">
    <div  class="chat-box-mobcon chat-box slimscrollleft chatbox-message">      
      <div class="chats"></div> 
    </div>
  </div>
...
function update_channel(){
  $('#call_btn,#unmute_audio1,#unmute_video1').addClass('hidden');
  $('#end_btn,.new_call').removeClass('hidden');
...
$('#muted_image_me,.vccall,#unmute_audio1,#mute_video1').addClass('hidden');
$('#mute_audio,#unmute_video,#mute_audio1,#unmute_video1,#end_btn').removeClass('hidden');
