...
<?php
 ...
 if($this->session->userdata('applicant_id') != '' && $this->session->userdata('role') == 0):  
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="ndashboxleft">
        ...
        <div class="inforow clearfix">
          <span class="pull-left">Amount Refund</span>
          <span class="pull-right">$0.00</span>
        </div>
        <div class="inforow clearfix">
    ...
    foreach($notification as $notify ){
         ...
         $session_id = $this->session->userdata('applicant_id');  
            ...
            <div class="msgcontent">
              ...
              <?php $user_name = $this->db->get_where('applicants',array('id'=>$notify['user_id']))->row_array(); ?>




                <h3><a href="<?php echo base_url();?>mentor-profile/<?php echo $user_name['username']; ?>" class="notification_link"><?php
        ...
        <div class="actcontainer" <?php echo (empty($activity_list)?'align="center"':''); ?>>
              ...
              <div class="actrow">
                <div class="row actrow-selected" id="row_<?php echo $activity['invite_id'];?>">
                  <div class="actimg">
                    ...
                    <!-- <div class="col-sm-2">2 Hours</div> -->
                      ...
                      elseif($activity['approved'] == 1 && date('Y-m-d H:i:s') >  date('Y-m-d H:i:s', strtotime($from_date_time)) ){
                       ...
                       if($count>0){
                         ...
                         <li><a href="'.base_url().'view-user/'.$activity['username'].'" >View</a></li>';   
                          ...
                          if(  $rating_count == 0 ){
                              $status .='<li id="li'.$activity['invite_id'].'"><a href="javascript:void(0)"  onclick="rate_call('.$activity['invite_id'].','.$activity['app_id'].')">Rate the Mentor</a></li>';
                             }                                                                                   
                         $status .='</ul>
                                   </div>';                                
          ...
          function delete_notify(){
            ...
            $.post('<?php echo base_url(); ?>user/delete_mentee_notification',{notify_id:notify_id},function(res){
