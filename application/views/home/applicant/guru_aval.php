          ...
          <?php if($value['day_name'] == date('l', strtotime($selected_date."+0 day"))) {
           ...
           if(is_array($explode_1)){
             foreach ($explode_1 as $index1 => $indexvalue1) {
              ...
              $from_times[] = $rep_start1;
              $to_times[] = $rep_end1;

            }

            echo '<pre>';print_r($from_times);
            print_r($to_times);
