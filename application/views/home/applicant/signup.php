		...
		<section class="mainarea account-box-area">
			<div class="container">
				<div class="account-box">
					...
					<h3 class="account-title">Signup</h3>					<span id="form-registeration-success" class="success" style="display: none;color:green;"></span>					<span id="form-registeration-error" class="error" style="display: none;color:green;"></span>
