 <style>
 .guru-msg-total{padding-left: :0px;}
      ...
      <div class="rightsidebar">
          ...
          <div class="col-md-12 mentor-search">
            <div class="input-group">
              <input class="pull-left form-control right_top_search"  name="right_top_search"  type="text" placeholder="Search by course or mentor..." value="<?php
          ...
          <div class="row">
            <div class="col-md-12 mentor-sort-by">
              <h3 class="widget-title pull-left">1 Matches for your search</h3>
