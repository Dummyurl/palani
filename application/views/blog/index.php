        ...
        <div class="container-fluid home-slider-container">
            <div class="row">
                ...
                if ($settings->slider_active == 1) {
                    $this->load->view('blog/partials/_slider', $slider_posts);
                }
                ?>
                ...
                <div class="content">
                    ...
                    <?php if ($layout == "layout_4" || $layout == "layout_5" || $layout == "layout_6"): ?>
                        <div class="first-tmp-slider">
                            ...
                            <?php
                            if ($settings->slider_active == 1) {
                                $this->load->view('blog/partials/_slider_second', $slider_posts);
                            }
                            ?>
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <?php foreach ($posts as $item): ?>
                                ...
                                <?php if ($count == 1): ?>
                                    ...
                                    <?php $this->load->view("blog/partials/_ad_spaces", ["ad_space" => "index_top"]); ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <?php $this->load->view("blog/partials/_ad_spaces", ["ad_space" => "index_bottom"]); ?>
                        </div>
                    </div>
