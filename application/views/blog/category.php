                ...
                <ol class="breadcrumb">
                    ...
                    <?php if ($category->parent_id != 0): ?>
                        ...
                        <?php if (!empty($parent_category)): ?>
                            <li class="breadcrumb-item">
                                <a href="<?php echo base_url(); ?>category/<?php echo html_escape($parent_category->slug); ?>"><?php echo html_escape($parent_category->name); ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8">
                <div class="content">
                        ...
                        <div class="row">
                            ...
                            <?php foreach ($posts as $item): ?>
                                ...
                                <?php if ($count == 1): ?>
                                    ...
                                    <?php $this->load->view("blog/partials/_ad_spaces", ["ad_space" => "category_top"]); ?>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="row">
                            <?php $this->load->view("blog/partials/_ad_spaces", ["ad_space" => "category_bottom"]); ?>
                        </div>
                    </div>
                    <!-- Pagination -->
                    <div class="col-xs-12 col-sm-12">
