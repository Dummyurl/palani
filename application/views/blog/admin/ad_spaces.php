            ...
            <div class="box-body">
                ...
                <?php if ($ad_codes->ad_space == "sidebar_top" || $ad_codes->ad_space == "sidebar_bottom"): ?>
                    <div class="form-group">
                        ...
                        <p><label class="control-label label label-ad">300x250 <?php echo trans('banner'); ?></label></p>
                        <div class="row row-ad-space">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row m-t-15">
                                    <div class="col-sm-12">
                                        <a class='btn bg-olive btn-sm'>
                                            <?php echo trans('select_image'); ?>
                                            <input type="file" name="file_ad_code_300" size="40" class="uploadFile"
                        ...
                        <p><label class="control-label label label-ad">234x60 <?php echo trans('banner'); ?></label></p>
                        <div class="row row-ad-space">
                            <div class="col-sm-6">
                                <label class="control-label"><?php echo trans('paste_ad_code'); ?></label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row m-t-15">
                                    <div class="col-sm-12">
                                        <a class='btn bg-olive btn-sm'>
                                            <?php echo trans('select_image'); ?>
                                            <input type="file" name="file_ad_code_234" size="40" class="uploadFile"
                                                   accept=".png, .jpg, .jpeg, .gif"
                ...
                <?php else: ?>
                    <div class="form-group">
                        ...
                        <p><label class="control-label label label-ad">728x90 <?php echo trans('banner'); ?></label></p>
                        <div class="row row-ad-space">
                            <div class="col-sm-6">
                                <label class="control-label"><?php echo trans('paste_ad_code'); ?></label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row m-t-15">
                                    <div class="col-sm-12">
                                        <a class='btn bg-olive btn-sm'>
                                            <?php echo trans('select_image'); ?>
                                            <input type="file" name="file_ad_code_728" size="40" class="uploadFile"
                                                   accept=".png, .jpg, .jpeg, .gif"
                        ...
                        <p><label class="control-label label label-ad">468x60 <?php echo trans('banner'); ?></label></p>
                        <div class="row row-ad-space">
                            <div class="col-sm-6">
                                <label class="control-label"><?php echo trans('paste_ad_code'); ?></label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row m-t-15">
                                    <div class="col-sm-12">
                                        <a class='btn bg-olive btn-sm'>
                                            <?php echo trans('select_image'); ?>
                                            <input type="file" name="file_ad_code_468" size="40" class="uploadFile"
                                                   accept=".png, .jpg, .jpeg, .gif"
                                                   onchange="$('#upload-file-info2').html($(this).val());">
                                        </a>
                                    </div>
